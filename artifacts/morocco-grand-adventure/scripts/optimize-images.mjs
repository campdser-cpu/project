...
const rels = [
  ...
  ...['merzouga','erg-chebbi','fes','meknes','casablanca','rabat','ouarzazate','ait-ben-haddou','zagora','dades-valley','todra-gorge','skoura','roses-valley','draa-valley','chefchaouen','imlil','ourika-valley','ouzoud','ifrane','essaouira','agadir','taghazout','legzira','el-jadida','tangier','tetouan','akchour','nkob','mirleft'].map((n)=> `dest/${n}.webp`),
  // curated (home hub cards + tour/destination galleries)
  ...['hassan-ii-mosque-interior-colonnades-casablanca','berber-guide-camel-sahara-desert-merzouga','ait-ben-haddou-bridge-town-unesco-morocco','couple-blue-steps-chefchaouen-medina','todra-gorge-river-canyon-high-atlas','cascading-waterfall-todra-gorge','tin-mal-mosque-pointed-arches-high-atlas','hassan-tower-mohammed-v-mausoleum-rabat','blue-streets-berber-carpets-chefchaouen-medina','marrakech-medina-street-life-locals-morocco','hassan-ii-mosque-exterior-arches-golden-hour-casablanca','handmade-baskets-blue-city-chefchaouen','blue-stairway-craft-shops-chefchaouen','leather-tanning-vats-fes-medina','ancient-water-channels-olive-groves-morocco','rolling-green-hills-village-mosque-northern-morocco','panoramic-view-chefchaouen-rif-mountains','hassan-ii-mosque-minaret-casablanca','hassan-ii-mosque-ornate-bronze-door-casablanca','marrakech-medina-motorbike-archway-local-life','tannery-workers-dyeing-pits-fes'].map((n)=> `curated/${n}.webp`),
