...
export const destinations: Destination[] = [
  // ── Imperial Cities ────────────────────────────────────────────────────────
  {
    ...
    description: "Marrakech is Morocco's red-walled southern capital and the starting point for most Sahara journeys. Behind the ramparts, the UNESCO-listed medina packs Jemaa el-Fnaa square, the Koutoubia minaret, the Bahia Palace and maze-like souks; outside the walls, the Majorelle Garden's cobalt blue and the Menara's reflecting pool give the city room to breathe. Give it two full days — one for the medina on foot, one for palaces, gardens and a hammam — because day trips into the High Atlas (Ourika, Imlil) start here as well. Practically, Marrakech is where Morocco Grand Adventure desert tours depart: the Tizi n'Tichka crossing toward Aït Ben Haddou and Merzouga begins at your riad door.",
  ...
  },
  {
    ...
    bestTime: "Mar – May, Sep – Nov",
    description: "Fes is Morocco's spiritual and cultural capital, home to the world's oldest continuously operating university (Al-Qarawiyyin) and one of the largest living medieval cities on earth. Fes el-Bali's 9,000-odd alleys are best navigated with a local guide — the Chouara Tannery's dye pits, the Bou Inania medersa's carved cedar and the sprawling Karaouiyine district reward a full day. Fes is also the most convenient departure point for the desert: the road to Merzouga via Ifrane, Midelt and the Ziz Valley is the shortest Sahara approach of any major city, and Morocco Grand Adventure's Fes-to-Merzouga and Fes-to-Marrakech routes start here.",
  ...
  // ── Sahara Desert ──────────────────────────────────────────────────────────
  {
    ...
    bestTime: "Oct – Apr",
        description: 'Merzouga is Morocco\'s most celebrated gateway to the Sahara, set at the foot of Erg Chebbi — a sea of golden sand dunes that rise to about 150 metres, the tallest dunes in the country. The village exists for one purpose: to put visitors onto the dunes, into the camel caravans and into desert camps under some of the clearest night skies in North Africa. It is where the road from Marrakech and Fes ends, and where the desert experience begins.',
    highlights: [
      "Erg Chebbi dunes (up to 150 m high — Morocco's tallest)",
      "Camel trekking at sunset into the camp",
      "Luxury and traditional desert camps",
      "Stargazing and astrophotography",
      "Khamlia music and nomadic culture",
      "Sunrise over the dunes",
      "Rissani weekly market",
    ],
  ...
  },
  {
    ...
    bestTime: "Oct – Apr",
    description: "Erg Chebbi is one of Morocco's two great ergs — large seas of sand dunes. Stretching roughly 28km long and up to 9km wide, its dunes climb to about 150 metres — the tallest free-standing dunes in the country — and change colour from orange to gold to crimson with the shifting light. Ride a camel at sunset, drive the crests by 4x4, or simply walk up from Merzouga for a sunrise with the sand to yourself; however you meet it, a night between these dunes is among the world's great travel experiences.",
  ...
  },
  {
    ...
    bestTime: "Sep – May",
    description: "Known internationally as the gateway to the Sahara and the 'Hollywood of Africa', Ouarzazate is where the Atlas mountains give way to desert. Blockbusters from Lawrence of Arabia to Gladiator and Game of Thrones have filmed here, and the Atlas Film Studios and Taourirt Kasbah make an easy half-day of sightseeing. For most Morocco Grand Adventure journeys it is a practical waypoint — close enough to Aït Ben Haddou for an afternoon visit, and the jumping-off point for the Draa Valley road south or the Dades road east toward Merzouga. Come for the kasbahs and film history, stay for the light: the surrounding stony desert turns gold at the end of every day.",
    highlights: ["Atlas Film Studios", "Taourirt Kasbah", "Aït Ben Haddou (30min)", "Draa Valley", "Fint Oasis", "Route of the Kasbahs"],
    region: "Southern Morocco",
    coords: { lat: 30.9189, lng: -6.8934 },
    gallery: [
      {
        src: "/images/dest/ouarzazate.webp",
        alt: "Ouarzazate, Morocco — kasbah architecture under a wide desert sky on the edge of the Sahara",
  ...
  },
  {
    ...
    bestTime: "Sep – May",
    description: "Aït Ben Haddou is the best-preserved ksar (fortified earthen village) in southern Morocco and a UNESCO World Heritage Site. Its stacked mud-brick towers have stood in for Jerusalem, Tibet and ancient Egypt on screen, but the real attraction is walking the raised alleys between them and climbing to the hilltop granary for the view over the Ounila valley. Half a day is enough: cross the river, wander the ksar, climb, and be back at the vehicle for lunch. It sits barely 30 minutes from Ouarzazate on the Marrakech–Sahara road, which makes it the most rewarding first-day stop on any Morocco Grand Adventure desert tour — arrive before mid-morning or in late afternoon to avoid the hottest light and the biggest crowds.",
    highlights: ["UNESCO Ksar", "Film Location Tour", "Sunrise Photography", "Berber Family Visits", "Pottery Workshops", "Hilltop Granary Views"],
    region: "Southern Morocco",
    ...
    gallery: [
      {
        ...
        caption: "The river winds beneath the 300-metre walls of the Todra Gorge.",
      },
      {
        src: "/images/curated/cascading-waterfall-todra-gorge.webp",
        alt: "Small waterfall cascading inside the Todra Gorge, Morocco",
  ...
  // ── Mountains ──────────────────────────────────────────────────────────────
  {
    ...
    bestTime: "Mar – May, Sep – Nov",
    description: "Wedged into the Rif Mountains, Chefchaouen is Morocco's most photographed town: a whole medina washed in shades of blue, from powder to indigo. Beyond the photos, it is a genuinely relaxed mountain town — walk the blue lanes early before the day-trippers arrive, climb to the Spanish Mosque viewpoint at sunset, and refuel at a rooftop table around Plaza Uta el-Hammam. The Akchour waterfalls and the natural stone arch of God's Bridge make a full-day hike for active travellers. Chefchaouen sits on the northern route between Tangier, Fes and the coast — it pairs naturally with an imperial-cities itinerary rather than a desert one, and Morocco Grand Adventure can link it into northern loops on request.",
    highlights: ["Blue Medina", "Plaza Uta el-Hammam", "Ras el-Ma Springs", "Akchour Waterfalls", "Rif Mountain Hikes", "Spanish Mosque Viewpoint"],
    region: "Northern Morocco",
    ...
    gallery: [
      {
        ...
        caption: "Handwoven Berber carpets add colour to a blue-washed medina lane.",
      },
      {
        src: "/images/curated/blue-stairway-craft-shops-chefchaouen.webp",
        alt: "Vibrant blue stairway with small craft shops in Chefchaouen, Morocco",
        caption: "A blue stairway lined with craft shops in the Blue Pearl.",
      },
      {
        src: "/images/curated/handmade-baskets-blue-city-chefchaouen.webp",
        alt: "Handmade baskets and souvenirs displayed in a shop in Chefchaouen, Morocco",
        caption: "Locally made baskets and souvenirs for sale in the Blue City.",
      },
      {
        src: "/images/curated/panoramic-view-chefchaouen-rif-mountains.webp",
        alt: "Panoramic view over the blue medina of Chefchaouen and the Rif Mountains, Morocco",
        caption: "The blue medina spreads below the Rif Mountains.",
      },
      {
        src: "/images/curated/couple-blue-steps-chefchaouen-medina.webp",
        alt: "Couple walking down blue-painted steps in the Chefchaouen medina, Morocco",
...
export const tours: Tour[] = [
  {
    ...
    // Published premium private price. The "from" figure is the two-traveller
    // per-person rate; the full ladder lives in src/data/pricing/ladder.ts.
    price: "425",
    pricingTiers: { 1: 600, 2: 425, 3: 410, 4: 395, 5: 380 },
    quoteOnly: false,
  ...
  },
  {
    ...
    faq: [
      { question: "Is this a fixed-price Agadir Sahara tour?", answer: "A starting price per person is published for this route. Your exact total depends on how many of you travel — the per-person price comes down as the group grows — and on the accommodation you choose, so we confirm the final figure with your dates before any payment. You are welcome to ask us to adjust the itinerary first." },
  ...
  },
  {
    ...
    price: "700",
    pricingTiers: { 1: 985, 2: 700, 3: 685, 4: 670, 5: 655 },
    quoteOnly: false,
  ...
  },
  {
    ...
    price: "805",
    pricingTiers: { 1: 1135, 2: 805, 3: 790, 4: 775, 5: 760 },
    quoteOnly: false,
  ...
  },
  {
    ...
    price: "1450",
    pricingTiers: { 1: 0, 2: 1450, 3: 0, 4: 0, 5: 0 },
    quoteOnly: false,
  ...
  },
  {
    ...
    price: "1050",
    pricingTiers: { 1: 1480, 2: 1050, 3: 1035, 4: 1020, 5: 1005 },
    quoteOnly: false,
  ...
  },
  {
    ...
    price: "950",
    pricingTiers: { 1: 1360, 2: 0, 3: 950, 4: 935, 5: 920 },
    quoteOnly: false,
  ...
  },
{
  ...
  price: "530",
  pricingTiers: { 1: 750, 2: 530, 3: 515, 4: 500, 5: 485 },
  ...
  faq: [
    { question: "Is this tour priced publicly?", answer: "A starting price per person is published for this route. Your exact total depends on how many of you travel — the per-person price comes down as the group grows — and on the accommodation you choose, so we confirm the final figure with your dates before any payment. You are welcome to ask us to adjust the itinerary first." },
...
},
{
  ...
  price: "425",
  pricingTiers: { 1: 600, 2: 425, 3: 410, 4: 395, 5: 380 },
  image: "/images/curated/hassan-tower-mohammed-v-mausoleum-rabat.webp",
  ...
  excluded: ["International flights", "Lunches and drinks", "Entrance fees", "Tips and personal expenses"],
  faq: [
    { question: "Is this a fixed-price Casablanca tour?", answer: "A starting price per person is published for this route. Your exact total depends on how many of you travel — the per-person price comes down as the group grows — and on the accommodation you choose, so we confirm the final figure with your dates before any payment. You are welcome to ask us to adjust the itinerary first." },
...
},
{
  ...
  price: "530",
  pricingTiers: { 1: 750, 2: 530, 3: 515, 4: 500, 5: 485 },
  image: "/images/curated/hassan-ii-mosque-ornate-bronze-door-casablanca.webp",
...
},
{
  ...
  price: "625",
  pricingTiers: { 1: 880, 2: 625, 3: 610, 4: 595, 5: 580 },
...
},
{
  ...
  price: "890",
  pricingTiers: { 1: 1255, 2: 890, 3: 875, 4: 860, 5: 845 },
  image: "/images/curated/hassan-ii-mosque-exterior-arches-golden-hour-casablanca.webp",
...
},
{
  ...
  price: "530",
  pricingTiers: { 1: 750, 2: 530, 3: 515, 4: 500, 5: 485 },
  image: "/images/curated/tannery-workers-dyeing-pits-fes.webp",
...
},
{
  ...
  faq: [
    { question: "Is this a fixed-price tour from Agadir?", answer: "A starting price per person is published for this route. Your exact total depends on how many of you travel — the per-person price comes down as the group grows — and on the accommodation you choose, so we confirm the final figure with your dates before any payment. You are welcome to ask us to adjust the itinerary first." },
...
},
  {
    ...
    price: "300",
    pricingTiers: { 1: 425, 2: 300, 3: 285, 4: 270, 5: 255 },
    quoteOnly: false,
  ...
  // ── Catalog expansion: Tangier / North Morocco, coastal escape, grand journey ──
  {
    id: "tangier-3-day",
    name: "3-Day North Morocco: Tangier, Chefchaouen & Tétouan",
    duration: "3 Days / 2 Nights",
    category: "Northern Morocco Route",
    highlights: ["Tangier's Kasbah and Strait of Gibraltar views", "Tétouan's UNESCO Andalusian medina", "Chefchaouen, the blue city", "Akchour gorges and God's Bridge", "A compact loop back to Tangier"],
    price: "425",
    pricingTiers: { 1: 600, 2: 425, 3: 410, 4: 395, 5: 380 },
    quoteOnly: false,
    image: "/images/dest/chefchaouen.webp",
    description: "A private three-day loop through Morocco's north, starting and finishing in Tangier. The route runs to the whitewashed Andalusian medina of Tétouan, then to Chefchaouen for two nights, with a day into the Akchour valley for its waterfalls and the natural stone arch known as God's Bridge. This is a different Morocco from the desert routes: green Rif mountains, Spanish-inflected architecture, and a slower, cooler pace.",
    ...
    faq: [
      { question: "Is this route different from the Sahara tours?", answer: "Yes. This loop stays entirely in northern Morocco — the Rif mountains, Chefchaouen and Tétouan — and does not travel to the Sahara. If you want the desert as well, ask us about combining this with a longer itinerary, or see the 5-day Tangier to Fes route." },
  ...
  {
    id: "tangier-5-day",
    name: "5-Day Tangier to Fes via the Rif & North Morocco",
    duration: "5 Days / 4 Nights",
    category: "Northern Morocco Route",
    highlights: ["Tangier departure, Strait of Gibraltar", "Tétouan's Andalusian medina", "Two nights in Chefchaouen with a full Akchour day", "Middle Atlas cedar forest and Ifrane", "One-way finish in Fes"],
    price: "625",
    pricingTiers: { 1: 880, 2: 625, 3: 610, 4: 595, 5: 580 },
    quoteOnly: false,
    image: "/images/dest/akchour.webp",
    description: "A one-way private route from Tangier to Fes, crossing the Rif mountains and the Middle Atlas rather than the southern desert road. Two nights in Chefchaouen give real time for the Akchour valley, then the route climbs through cedar forest to Ifrane before finishing in the imperial city of Fes — a north-to-south introduction to Morocco for travelers arriving by ferry or flight into Tangier.",
    ...
    excluded: ["International flights", "Lunches and drinks", "Monument and museum entrance fees", "Tips and personal expenses"],
    faq: [
      { question: "Why travel from Tangier to Fes through the north instead of the desert route?", answer: "This itinerary is built around the Rif and northern Morocco rather than the Sahara — Chefchaouen, Tétouan and Akchour, then the Middle Atlas cedar forests. If you want the Sahara as well, our Fes-based desert routes pick up from where this one finishes." },
      { question: "Does this tour finish in Fes?", answer: "Yes, it's a one-way private route ending in Fes. Onward travel — south to Merzouga, or elsewhere — can be discussed as a separate leg once you're there." },
      { question: "Is two nights enough in Chefchaouen?", answer: "It gives a full day for Akchour without rushing, plus the evening to walk the medina — more time than a one-night stop allows. Groups who want longer in the north can ask about extending it." },
      { question: "Can I book now and pay later?", answer: "Yes. Sending a request is free and commits you to nothing. We confirm your dates, itinerary and final price with you first; a 20% deposit then secures the booking, and the remaining 80% is paid on arrival in Morocco." },
    ],
  },
  {
    id: "marrakech-essaouira-2-day",
    name: "2-Day Marrakech to Essaouira: Atlantic Coast Escape",
    duration: "2 Days / 1 Night",
    category: "Coastal Escape",
    highlights: ["Three-hour private transfer to the Atlantic coast", "Essaouira's UNESCO-listed medina", "Sqala du Port ramparts and the fishing harbour", "A genuine change of pace from Marrakech", "Round trip back to Marrakech"],
    price: "300",
    pricingTiers: { 1: 425, 2: 300, 3: 285, 4: 270, 5: 255 },
    quoteOnly: false,
    image: "/images/catalog/essaouira-sqala-du-port-atlantic.webp",
    description: "A short private escape from Marrakech to Essaouira, the windswept Atlantic port the Moroccan National Tourist Office lists among the country's classic coastal towns. Three hours from the Red City, Essaouira trades souks and heat for sea air, a UNESCO-listed medina of blue-shuttered lanes, and the Sqala du Port ramparts facing the swell. This is a coast-and-culture pairing rather than a desert route — the shortest way to see a genuinely different side of Morocco from Marrakech.",
    ...
    faq: [
      { question: "Is this tour part of a Sahara itinerary?", answer: "No — this is a coastal route only, with no desert leg. Travelers who want both the coast and the Sahara in one trip should look at our 8-day Marrakech, Essaouira, Agadir & Sahara journey instead." },
  ...
  {
    id: "14-day-grand-morocco-journey",
    name: "14-Day Grand Morocco: Imperial Cities, Atlantic Coast, Sahara & the North",
    duration: "14 Days / 13 Nights",
    category: "Grand Journey",
    highlights: ["Marrakech, the Atlantic coast, the south, the Sahara, the imperial cities and the north in one private route", "Two full nights at Erg Chebbi, including a full desert day", "Aït Ben Haddou, Dades Valley and Todra Gorge", "Fes el-Bali with an official local guide", "Chefchaouen and a finish in Casablanca"],
    price: "",
    ...
    itineraryDays: [
      { day: 1, title: "Arrival in Marrakech", desc: "Settle in and take a first, unhurried walk through the medina and Jemaa el-Fna in the evening.", stops: ["Overnight: Marrakech (Breakfast)"] },
      ...
      { day: 11, title: "Chefchaouen", desc: "A full day in and around the blue city — the medina, Plaza Uta el-Hammam, and the viewpoint above town — at a deliberately slower pace after nine days on the road.", stops: ["Chefchaouen medina", "Overnight: Chefchaouen (Breakfast)"] },
      { day: 12, title: "Chefchaouen → Rabat", desc: "Head south to Rabat, Morocco's capital, for the Kasbah of the Udayas and the Hassan Tower.", stops: ["Rabat", "Overnight: Rabat (Breakfast)"] },
      { day: 13, title: "Rabat → Casablanca", desc: "A short final drive to Casablanca, with time for the Hassan II Mosque on the Atlantic and the art-deco streets of the city centre.", stops: ["Hassan II Mosque", "Overnight: Casablanca (Breakfast)"] },
      { day: 14, title: "Departure from Casablanca", desc: "Transfer to Casablanca airport, or onward as agreed in your confirmed itinerary.", stops: ["End: Casablanca"] },
    ],
    included: ["Private air-conditioned vehicle and driver-guide for the full route, when included in the confirmed quote", "Accommodation for 13 nights, according to the selected package, including two nights at a desert camp near Merzouga", "Official local guide for the Fes medina day", "The desert experience at Erg Chebbi — sunset camel trek — when included in the confirmed itinerary", "Hotel and airport pick-up and drop-off"],
    excluded: ["International flights", "Lunches and drinks", "Monument and museum entrance fees", "Optional activities such as 4x4 excursions, quad biking or a hot air balloon flight", "Tips and personal expenses", "Anything not written into your confirmed quote"],
    faq: [
      { question: "Why is this tour quote-only when the shorter tours have a published price?", answer: "A fourteen-day private route varies a great deal by season, pace and the accommodation standard you choose, in a way a single headline price can't represent honestly. We confirm the real figure once we know your dates, party size and preferences." },
      { question: "Is fourteen days too long, or too much driving?", answer: "It's built from the same legs as our shorter tours, joined together rather than compressed — two full nights at the dunes instead of one, and multi-night stops in Fes and Chefchaouen so it isn't a different city every day. If two weeks is more than you want, ask us about the 7-day or 10-day versions of this same route." },
