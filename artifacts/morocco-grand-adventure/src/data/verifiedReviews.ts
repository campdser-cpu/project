 ...
 *
 * Review evidence images below are cropped/resized derivatives of the supplied
 * screenshots. Cropping removes unrelated browser chrome or adjacent reviews;
 * no review content, customer wording, rating, or attribution is altered.
 */
export const verifiedGoogleReviews: VerifiedGoogleReview[] = [
  {
    ...
    images: [
      {
        src: '/review-assets/images/nina-branderhorst-google-review.jpg',
        alt: 'Supplied Google review screenshot for Nina Branderhorst, including her review and customer photo',
        width: 360,
        height: 519,
      },
    ],
  },
  {
    ...
    images: [
      {
        src: '/review-assets/images/alessandra-raspini-google-review.jpg',
        alt: 'Supplied Google review screenshot for Alessandra Raspini',
        width: 360,
        height: 283,
      },
    ],
  },
  {
    ...
    images: [
      {
        src: '/review-assets/images/natalia-cuadrado-google-review.jpg',
        alt: 'Supplied Google review screenshot for Natalia Cuadrado',
        width: 300,
        height: 219,
      },
    ],
  },
  {
    ...
    images: [
      {
        src: '/review-assets/images/cora-ciampolini-google-review.jpg',
        alt: 'Supplied Google review screenshot for Cora Ciampolini with her customer photos',
        width: 300,
        height: 484,
      },
    ],
  },
  {
    ...
    images: [
      {
        src: '/review-assets/images/m-dr-google-review.jpg',
        alt: 'Supplied Google review screenshot for M DR',
        width: 360,
        height: 298,
      },
    ],
  },
  {
    ...
    images: [
      {
        src: '/review-assets/images/kresimir-mikic-google-review.jpg',
        alt: 'Supplied Google review screenshot for Krešimir Mikić with customer photos',
        width: 300,
        height: 433,
      },
    ],
