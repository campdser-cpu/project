...
export const routeMetadata: Record<string, RouteMeta> = {
  ...
  '/merzouga-guide':{title:'Merzouga Travel Guide — Sahara Desert & Erg Chebbi',description:'A practical guide to Merzouga, Erg Chebbi, camel trekking and desert camp experiences.',ogImage:'/images/library/erg-chebbi-dunes-blue-hour-morocco-mga-033.jpg'},
