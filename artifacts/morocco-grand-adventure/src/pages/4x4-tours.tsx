...
export default function FourByFourTours() {
  ...
  return (
    ...
    >
      ...
      {/* Official photo library — actual PDF photographs (quad-biking / 4x4 contexts) */}
      <section className="py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <LibraryPhotoGrid photos={publishablePhotosForContexts(['quad-biking'])} aspect="h-60 md:h-72" />
