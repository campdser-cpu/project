...
export default {
    ...
    trust_travelers: "Happy Travelers",
    ...
    award_best_operator: "Morocco Travel Specialists",
    award_tripadvisor: "Local Berber Guides",
    award_trusted: "Private & Personalized Tours",
    ...
    exp_rating: "Traveler Reviews",
    exp_travelers: "Private & Personalized",
    ...
    lc_faq5_q: "What is stargazing like at the luxury camp?",
    lc_faq5_a: "With no nearby lights, Erg Chebbi offers some of the clearest night skies on earth. After dinner, our Berber guides point out constellations and share their stories, often with a telescope for the Milky Way.",
    lc_faq6_q: "What should I bring for my night at camp?",
    lc_faq6_a: "A warm jacket and closed shoes are essential — desert nights are cold even in summer. Also useful: a headlamp or small flashlight, any personal medication, and an appetite for mint tea and Moroccan flavours.",
    lc_faq7_q: "Can I combine the luxury camp with other experiences?",
    lc_faq7_a: "Yes — the camp fits naturally into our Merzouga and Sahara tours. Guests typically arrive on camel at sunset, spend the night, then continue the next morning by 4x4 or camel, all arranged privately.",
    // ── Camel Trekking page ──
    ...
    ct_faq6_q: "What should I bring on a camel trek?",
    ct_faq6_a: "Bring water, a camera, and a light jacket — desert temperatures drop sharply after sunset. We provide the camels, an experienced Berber guide, and the camp; you only need to bring yourself.",
    ct_faq7_q: "What happens once we reach the desert camp?",
    ct_faq7_a: "You are welcomed with sweet mint tea, shown to your tent, and then enjoy a gourmet dinner around the fire. Evenings bring gentle music and stargazing; you sleep in a real bed and are served breakfast before sunrise, with a camel ride back to Merzouga at dawn.",
    ct_faq8_q: "Is a camel trek the same as a short camel ride?",
    ct_faq8_a: "No. This is a genuine trek across the dunes, not a short paddock ride. Our treks last 45 minutes to over an hour and end at our private luxury camp in time for sunset.",
    // ── 4x4 Tours page ──
    ...
    mk_hero_alt: "The vibrant Jemaa el-Fnaa square and medina rooftops of Marrakech at dusk",
    mk_breadcrumb: "Marrakech Tours",
    mk_title: "Marrakech Tours",
    mk_subtitle: "Discover the Red City with expert local guides — Jemaa el-Fnaa, the Majorelle Garden, the labyrinthine souks, and unforgettable day trips to the Atlas Mountains and the Sahara.",
    mk_cta: "Book a Marrakech Tour",
    mk_f1_title: "Jemaa el-Fnaa Square",
    mk_f1_desc: "Storytellers, musicians and food stalls fill this UNESCO-listed square each evening — the beating heart of the Red City.",
    mk_f2_title: "Majorelle Garden & Museums",
    mk_f2_desc: "Cobalt-blue lanes, exotic plants and the Berber museum once owned by Yves Saint Laurent — book early, it sells out.",
    mk_f3_title: "Bahia Palace & Saadian Tombs",
    mk_f3_desc: "Zellige tilework, carved cedar ceilings and serene courtyards from Morocco's 19th-century architectural golden age.",
    mk_f4_title: "Medina Souks",
    mk_f4_desc: "Wander the artisan quarters for leather, lanterns and carpets — haggling is expected, and your guide helps you bargain fairly.",
    mk_f5_title: "Traditional Hammam & Spa",
    mk_f5_desc: "A black-soap scrub and steam ritual in a historic hammam — the perfect recovery after a long desert drive or a day of shopping.",
    mk_f6_title: "Atlas & Desert Day Trips",
    mk_f6_desc: "Ourika Valley, Ouzoud Falls and the Agafay stone desert are all within 90 minutes of the city — ideal between tour days.",
    mk_faq1_q: "How many days do I need in Marrakech?",
    mk_faq1_a: "Two to three days covers the medina highlights, a garden or two, and one day trip. Add an extra night if you want time for a hammam and unhurried souk browsing.",
    mk_faq2_q: "Is Marrakech safe for tourists?",
    mk_faq2_a: "Yes — the tourist areas are well policed and violent crime is rare. Expect friendly but persistent vendors; a local guide makes navigation and bargaining far more relaxed.",
    mk_faq3_q: "What are the best day trips from Marrakech?",
    mk_faq3_a: "The Ourika Valley (1h), Ouzoud Falls (2.5h) and Essaouira (2.5–3h) are classics. For dunes without a long drive, the Agafay desert is only 45 minutes away — though note it is a stone desert, not the Sahara.",
    mk_faq4_q: "Can I start a Sahara tour from Marrakech?",
    mk_faq4_a: "Absolutely — most of our guests do. Our most popular route is the 3-day Sahara tour via Ait Ben Haddou and the Dades Valley, finishing with a camel trek into Erg Chebbi at Merzouga.",
    // ── Day Trips page ──
    ...
    dt_f7_title: "From Marrakech: Agafay Desert",
    dt_f7_desc: "A rocky stone desert just 40–60 minutes from the city — lunar landscapes, the Atlas backdrop, and a short desert escape. Note: it is not a sand-dune desert.",
    dt_faq5_q: "What is the Agafay Desert?",
    dt_faq5_a: "The Agafay is a rocky, stone desert on the edge of the High Atlas, about 40–60 minutes from Marrakech. Its wide, lunar-like landscape makes it an easy desert escape without a long drive — but it has no sand dunes.",
    dt_faq6_q: "Is Agafay part of the Sahara?",
    dt_faq6_a: "No. Agafay is a stony (reg) desert landscape near Marrakech with no sand dunes. The Sahara is the vast desert region that includes the Merzouga and Erg Chebbi sand seas far to the southeast. For camel treks over rolling dunes and the classic Sahara camp experience, Merzouga is the destination.",
    rel_title: "Keep exploring Morocco",
    rel_sub: "Learn more about the desert experiences, tours and destinations that make Morocco unforgettable.",
    // ── Merzouga Guide page ──
    ...
    mg_faq5_q: "What can I actually do in Merzouga?",
    mg_faq5_a: "Camel trekking at sunset, sunrise over the dunes, luxury desert camps, 4x4 excursions to nomad camps and fossil beds, quad biking, and visits to Khamlia for Gnawa music. Each activity can be arranged privately from Merzouga.",
    mg_faq6_q: "What should I pack for a Merzouga desert trip?",
    mg_faq6_a: "Pack for large day-to-night temperature swings: long trousers and closed shoes, a scarf and sun protection, a warm jacket for cool nights, a hat and camera. Bring modest clothing for village visits and some cash for tips.",
    mg_faq7_q: "What is the desert like at night in Merzouga?",
    mg_faq7_a: "After sunset the dunes go quiet. Around camp there is a fire, mint tea, traditional music, and — with no light pollution — some of the clearest stars in the world. Nights can be cold, so bring a warm jacket.",
    // ── Desert Tours page ──
    ...
    home_trust_eyebrow: "Why travelers choose Morocco Grand Adventure",
    home_trust_title: "A family-run Morocco tour specialist",
    home_trust_sub: "We are a family-run Morocco travel company of native Berber guides from Merzouga, on the edge of the Sahara — offering private, tailored journeys across Morocco.",
    home_trust_t1_title: "Native Berber guides",
    home_trust_t1_text: "Our guides grew up in Merzouga and know the dunes, the villages and the culture firsthand.",
    home_trust_t2_title: "Private, tailored tours",
    home_trust_t2_text: "Every journey is private for your party, with a dedicated driver-guide and your own pace.",
    home_trust_t3_title: "Genuine customer feedback",
    home_trust_t3_text: "Past travelers share their Morocco experiences on our Google Business Profile, in their own words.",
    home_trust_t4_title: "Direct, personal contact",
    home_trust_t4_text: "Plan your trip directly with us on WhatsApp — no intermediaries.",
    home_trust_cta_reviews: "Read our reviews on Google",
    home_trust_cta_whatsapp: "Message us on WhatsApp",
    home_trust_note: "Past guests' reviews on our Google Business Profile are the travelers' own words and opinions. We do not fabricate testimonials.",
    // ── About page ──
