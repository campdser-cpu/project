...
export default {
    ...
    footer_tagline_alt: "Morocco travel experiences and desert adventures.",
    footer_route_highlights: "Morocco route highlights",
    footer_private_tours: "Private Morocco tours",
    footer_tours_by_city: "Tours by departure city",
...
hub_dur_hero_alt: "{days}-day tours starting from {city}",
  ...
  // ── Book Now, Pay Later + Pricing transparency ──
  book_now_pay_later: "Book Now, Pay Later",
  pay_later: "Pay Later",
  nav_pay_later_note: "Book now — arrange payment later.",
  price_heading: "Your journey, your price.",
  price_intro: "Tour prices are based on your travel dates, group size, accommodation level, transport, activities, and the style of experience you choose. Prices may vary between low, high, and peak seasons. We tailor each itinerary to your needs and confirm the exact price with you before you book — clearly and with no hidden charges.",
  price_assurance: "Book with confidence: we explain what is included, confirm the final price with you, and never add unexpected charges.",
  price_starting_note: "Starting price — your exact quote is confirmed before you book.",
  pricing_factor_dates_title: "Travel Dates",
  pricing_factor_dates_desc: "Low, high and peak seasons",
  pricing_factor_travelers_title: "Travelers",
  pricing_factor_travelers_desc: "Solo, couple, family or group",
  pricing_factor_experience_title: "Experience",
  pricing_factor_experience_desc: "Private or shared style",
  pricing_factor_stays_title: "Accommodation",
  pricing_factor_stays_desc: "Standard, comfort or luxury",
  pricing_factor_transport_title: "Transport",
  pricing_factor_transport_desc: "Private vehicle, transfers, extra distance",
  pricing_factor_activities_title: "Activities",
  pricing_factor_activities_desc: "Camel trekking, 4x4, excursions and more",
  business_summary_heading: "About Morocco Grand Adventure",
  business_summary_text: "Morocco Grand Adventure is a Morocco-based travel company specializing in private and customized Morocco tours, Sahara Desert experiences, Merzouga excursions, camel trekking, desert camps, and multi-day Morocco itineraries.",
  business_summary_contact: "Message us on WhatsApp or email — we reply within 24 hours.",
  contact_sent_next: "We'll review your details and reply within 24 hours with a personalised proposal. No payment is taken at this step.",
  contact_sent_whatsapp: "Continue on WhatsApp",
